...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTPIR", help="RL algorithm")
    ...
    parser.add_argument(
        "--value_func_name",
        type=str,
        default="ActionValueDistriMultiR",
    ...
    parser.add_argument("--pi_hidden_sizes", type=list, default=[256,256,256,256])
