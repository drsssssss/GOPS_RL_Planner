...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="GaussNNDistribution",
        help="Options: default/TanhGaussDistribution/GaussDistribution/GaussNNDistribution",
    )
    ...
    std = np.tile(np.array([0.0,0.0], dtype=np.float32), action_seq_len)
