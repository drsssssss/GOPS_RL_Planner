...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_threads_main", type=int, default=2, help="Number of threads in main process")
    ...
    parser.add_argument("--vector_env_num", type=int, default=3, help="Number of vector envs")
    ...
    parser.add_argument(
        "--trainer",
        type=str,
        default="off_async_idsim_trainer",
    ...
    parser.add_argument("--sample_batch_size", type=int, default=60)
