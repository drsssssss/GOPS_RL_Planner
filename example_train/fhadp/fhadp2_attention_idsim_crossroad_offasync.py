...
#
#  Description: example for fhadp2 + idsim + attention + off_async
...
if __name__ == "__main__":
    ...
    parser.add_argument("--attn_begin",type=int,default=112) # 112, 162
    parser.add_argument("--attn_end",type=int,default=183) # 183, 233
    ...
    parser.add_argument("--trainer", type=str, default="off_async_idsim_trainer",
                        help="off_async_idsim_trainer/off_sync_trainer/on_serial_trainer")
    trainer_type = parser.parse_known_args()[0].trainer
    # 4.3. Parameters for sync or async trainer
    if (
        trainer_type.startswith("off_async")
    ):
